...
def test_breadth_traversal(make_graph):
    g = make_graph
    assert g.breadth_first_traversal('n0') == [
        'n0', 'n1', 'n6', 'n7', 'n2', 'n5', 'n8', 'n3', 'n4', 'n9'
    ]


def test_depth_traversal(make_graph):
    g = make_graph
    assert g.depth_first_traversal('n0') == [
        'n{}'.format(i) for i in range(10)
    ]
